...
public class MapsSortValue {
	...
	public static void main(String args[]){  
		 ...
		 *  map.put(100,"Amit");
		 *  map.put(101,"Vijay");
		 * map.put(102,"Rahul"); //Returns a Set view of the mappings contained in this map
		 ...
		 * .sorted(Map.Entry.comparingByValue(Comparator.reverseOrder())) //Performs an action for each element of this stream
