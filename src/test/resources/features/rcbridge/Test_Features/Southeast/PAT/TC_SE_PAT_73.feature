...
Feature: TC_SE_PAT_AR_73
  ...
  Scenario Outline: TC_SE_PAT_AR_73 - [RL0] Author PAT contract in <site>
  ...
  Scenario Outline: TC_SE_PAT_AR_73 - [RL0] Amend PAT contract in <site>
