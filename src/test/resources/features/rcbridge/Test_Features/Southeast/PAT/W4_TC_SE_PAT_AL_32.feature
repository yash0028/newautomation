...
Feature: W4_TC_SE_PAT_AL_32
  ...
  Scenario Outline: W4_TC_SE_PAT_AL_32 - [RL0] Author PAT contract in <site>
  ...
  @AMENDMENT_ALL_PAT
  @PAT_SE_AMEND
  Scenario Outline: W4_TC_SE_PAT_AL_32 - [RL0] Amend PAT contract in <site>
