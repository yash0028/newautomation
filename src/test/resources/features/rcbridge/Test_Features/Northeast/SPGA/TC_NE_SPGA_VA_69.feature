...
Feature: TC_NE_SPGA_VA_69
  ...
  Scenario Outline: TC_NE_SPGA_VA_69 - [RL0] Author SPGA contract in <site>
   ...
   #CMD Check
     And I Verify CMD and Capture Status
      ...
      Examples:
          ...
          | northeast uhn   | SPGA          | TC_NE_SPGA_VA_69|


    	@TC_NE_SPGA_VA_69
        @Manual
        @User_Interface
        @UAT_AUTO_AMANDAMENT1
    ...
    #Amandments section - Fee Schedule
