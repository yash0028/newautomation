...
Feature: TC_NE_SPGA_VA_56
  ...
  Scenario Outline: TC_NE_SPGA_VA_56 - [RL0] Author SPGA contract in <site>
   ...
   #Final capture
    ...
    Examples:
      ...
      | northeast uhn | SPGA          | TC_NE_SPGA_VA_56|
  ...
  Scenario Outline: TC_NE_SPGA_VA_56 - [RL0] Author SPGA contract in <site>
    Given I am logged into Exari Dev as a valid user and go to the "<site>" site
    #Draft
    And I am using the "<TCName>" data from "<paperType>_NE_VA_J.csv" of "<site>" and paper type "<paperType>"
