...
#Last Updated : 2020-03-16 20:56:28.520677
Feature: W6_TC_NE_SPGA_NJ_4
    @W6_TC_NE_SPGA_NJ_4
    @Manual
    @User_Interface
    @UAT_AUTO
    ...
    @UAT_AUTO_INITIAL_TRANSACTION_ALL_SPGA
    @UAT_AUTO_INITIAL_TRANSACTION_ALL_SPGA_W6
    @UAT_AUTO_INITIAL_TRANSACTION_ALL_SPGA_NE
    @UAT_AUTO_INITIAL_TRANSACTION_ALL_SPGA_NE_W6
...
#End NDB Checking
    ...
    Examples:
      ...
      | northeast uhn | SPGA           | W6_TC_NE_SPGA_NJ_4 |
    ...
    @UAT_AUTO_AMENDMENT_ALL_SPGA
    @UAT_AUTO_AMENDMENT_ALL_SPGA_W6
    @UAT_AUTO_AMENDMENT_ALL_SPGA_NE
    @UAT_AUTO_AMENDMENT_ALL_SPGA_NE_W6
    @UAT_AUTO_MAKE_A_CORRECTION
    @UAT_AUTO_MAKE_A_CORRECTION_NORTHEAST
    @UAT_AUTO_MAKE_A_CORRECTION_W6
    @UAT_AUTO_MAKE_A_CORRECTION_ALL_SPGA
    @UAT_AUTO_MAKE_A_CORRECTION_ALL_SPGA_W6
    @UAT_AUTO_MAKE_A_CORRECTION_ALL_SPGA_NE
    @UAT_AUTO_MAKE_A_CORRECTION_ALL_SPGA_NE_W6
