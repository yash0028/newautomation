...
Feature: TC_NE_PAT_VA_64
  ...
  Scenario Outline: TC_NE_PAT_VA_64 - [RL0] Author PAT contract in <site>
    ...
    Examples:
      ...
      | northeast uhn   | PAT           | TC_NE_PAT_VA_64|
  ...
  @UAT_AUTO_NORTHEAST
  @AMENDMENT_ALL_PAT
  Scenario Outline: TC_NE_PAT_VA_64 - [RL0] Amend PAT contract in <site>
