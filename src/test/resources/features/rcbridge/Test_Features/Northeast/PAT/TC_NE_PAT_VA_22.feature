...
Feature: TC_NE_PAT_VA_22
  ...
  Scenario Outline: TC_NE_PAT_VA_22 - [RL0] Author PAT contract in <site>
    ...
    Examples:
      ...
      | northeast uhn   | PAT           | TC_NE_PAT_VA_22|
  ...
  Scenario Outline: TC_NE_PAT_VA_22 - [RL0] Amend PAT contract in <site>
