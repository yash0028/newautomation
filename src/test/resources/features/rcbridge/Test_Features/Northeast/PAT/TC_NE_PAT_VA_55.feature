...
Feature: TC_NE_PAT_VA_55
  ...
  Scenario Outline: TC_NE_PAT_VA_55 - [RL0] Author PAT contract in <site>
  ...
  Scenario Outline: TC_NE_PAT_VA_55 - [RL0] Amend PAT contract in <site>
