...
Feature: W3_TC_NE_SMGA_RI_26
  ...
  Scenario Outline: W3_TC_NE_SMGA_RI_26 - [RL0] Author SPGA contract in <site>
  ...
  @SMGA_AMANDMENT
  @WAVE3AMENDMENT
  Scenario Outline: W3_TC_NE_SMGA_RI_26 - [RL0] Author SMGA contract in <site>
