...
Feature: TC_NE_MGA_VA_67
  ...
  Scenario Outline: TC_NE_MGA_VA_67- [RL0] Author <paperType> contract in <site>
    ...
    Examples:
      ...
      | northeast uhn | MGA           | TC_NE_MGA_VA_67 |
  ...
  Scenario Outline: TC_NE_MGA_VA_67- [RL0] Amend <paperType> contract in <site>
