...
Feature: W3_TC_NE_MGA_CT_04
  ...
  @generate_link
  Scenario Outline: W3_TC_NE_MGA_CT_04 - [RL0] Author <paperType> contract in <site>
    ...
    Examples:
      ...
      | northeast uhn | MGA           | W3_TC_NE_MGA_CT_04 |
  ...
  @AMENDMENT_ALL_MGA
  Scenario Outline: W3_TC_NE_MGA_CT_04 - [RL0] Amend <paperType> contract in <site>
