...
Feature: W3_TC_NE_MGA_MD_01
  ...
  @generate_link
  Scenario Outline: W3_TC_NE_MGA_MD_01 - [RL0] Author <paperType> contract in <site>
  ...
  @AMENDMENT_ALL_MGA
  Scenario Outline: W3_TC_NE_MGA_MD_01 - [RL0] Amend <paperType> contract in <site>
