...
Feature: TC_WEST_PAT_OR_27
  ...
  @UAT_AUTO_INITIAL_TRANSACTION_PAT_WEST
  @UAT_AUTO_INITIAL_TRANSACTION1
  Scenario Outline: TC_WEST_PAT_OR_27 - [RL0] Author PAT contract in <site>
    ...
    Examples:
      ...
      | west uhn     | PAT           | TC_WEST_PAT_OR_27|
