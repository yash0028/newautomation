#Author commercial with 1 ALD group and 1 Mid-level PAT contract, execute and load contract, verify contract fed_Non standard_Fee schedule change
# Last updated on
@PATBusinessTestcases_OR
@releaseUnknown
@iterationUnknown
Feature: TC_WEST_PAT_OR_64
  ...
  Scenario Outline: TC_WEST_PAT_OR_64 - [RL0] Author PAT contract in <site>
    ...
    Examples:
      ...
      | west uhn      | PAT           | TC_WEST_PAT_OR_64|
  ...
  @AMENDMENT_ALL_PAT
  Scenario Outline: TC_WEST_PAT_OR_64 - [RL0] Amend PAT contract in <site>
