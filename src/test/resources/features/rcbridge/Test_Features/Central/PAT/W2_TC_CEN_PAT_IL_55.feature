...
Feature: W2_TC_CEN_PAT_IL_55
  ...
  Scenario Outline: W2_TC_CEN_PAT_IL_55 - [RL0] Author PAT contract in <site>
 ...
 #CMD Check
    ...
    Examples:
      ...
      | central uhn   | PAT          | W2_TC_CEN_PAT_IL_55|
  ...
  @AMENDMENT_ALL_PAT
  Scenario Outline: W2_TC_CEN_PAT_IL_55 - [RL0] Amend PAT contract in <site>
