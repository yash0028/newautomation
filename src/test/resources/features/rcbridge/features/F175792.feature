...
Feature: F175792 - Extract - Physician Providers for Provider Roster (Part 1 of 2)
  ...
  @US1096651
  @2018.PI03
  Scenario: US1096651 - [Continued] Populate Provider Roster Extract with Emptoris Lines tab information
  ...
  @US1303389
  @2018.PI03
  Scenario: US1303389 - [Unfinished] Populate Provider Roster Extract with Emptoris Lines tab information
    Given I am processing the a contract's Lines tab during the migration process
    When I reference the defined columns for the new Exari roster
    Then I am able to populate the data into the same column format as the Exari roster

  @US1303388
  Scenario: US1303388 - Populate Provider Roster Extract with Emptoris Lines tab information
    Given I am processing the a contract's Lines tab during the migration process
    When I reference the defined columns for the new Exari roster
    Then I am able to populate the data into the same column format as the Exari roster
