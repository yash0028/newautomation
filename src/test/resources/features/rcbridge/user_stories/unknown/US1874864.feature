...
Feature: US1874864 - Rename process name
  ...
  Scenario: TC868374 - [RL0]
    ...
    Then the Process Initiator can rename the process
    And the assigned Playbook Owner is an involved user
    ...
    And upon completion of this task, a new instance of the task is created
