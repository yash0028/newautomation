...
Feature: US2027165 - Locked Language Request – Market Lead
  ...
  Scenario: TC967069 - [RL1]
    ...
    Then Market lead has 2 outcome buttons - "Approve Locked Language Request" and "Deny Locked Language Request"
  ...
  Scenario: TC967076 - [RL2]
    Given "Locked Language Request - Market Lead" exists
    When the outcome button "Approve Locked Language Request" is used
  ...
  Scenario: TC967082 - [RL3]
    Given "Locked Language Request - Market Lead" exists
    When the outcome button "Deny Locked Language Request" is used
