...
Feature: US1287619 - Create CMD Contract Config database
  ...
  Scenario: TC565219 - [RL1]
    ...
    And the transaction response message contains INVALID ADDR SEQ FOR REASSIGNED PROV, IPA NUMBER NOT VALID FOR THE REASSIGNED PROVIDER, PCP REASSIGNMENT MPIN IS REQUIRED When PCP CONTRACT IS TERMED, REASSIGNED MPIN NOT VALID t
