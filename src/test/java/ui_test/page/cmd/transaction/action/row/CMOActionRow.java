...
public class CMOActionRow implements IFactoryPage, IWebInteract {
    private static final Logger log = LoggerFactory.getLogger(CMOActionRow.class);
    ...
    */
    ...
    public CMOActionRow(WebDriver driver, WebElement elementRow, WebElement detailRow) {
        this.driver = driver;
